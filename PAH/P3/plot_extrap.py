...
cc=['#00008B','#008000','#008000','#008000','#4B0082','#008000','#008000','#008000','#008000','#008000','#008000','#4B0082','#4B0082','#008000','#008000','#4B0082','#008000']
fig, ax = plt.subplots()
...
for key in energy_var:
    ...
    for j in range(len(x)):
        ax.plot(x[j], y[j], marker='o', linestyle='-', markersize=8, color=cc[key])
        ax.plot(x[j], z[j], marker='x', linestyle=' ', markersize=8, color=cc[key])
...
ax.legend(handles=[black_patch, blue_patch, green_patch], loc='center right',bbox_to_anchor=(1, 0.3))
# ax.legend(handles=[black_patch, blue_patch, green_patch], loc='upper center')
# ax.legend()
...
fig.savefig(file+'_extrap_.pdf', dpi=300, bbox_inches='tight')
