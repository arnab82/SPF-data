...
ecore = ints.h0
#@load "cluster_bases_100_TT.jld2"
...
e_var, v_var = FermiCG.block_sparse_tucker(v2, cluster_ops, clustered_ham,
                                               ...
                                               tol_tucker  = 1e-4,
                                               solver      = "davidson")
@save "/home/arnab22/FermiCG-data/papers/excited_state_tpsci/tetracence_tetramer/spt_75_var.jld2" e_var  v_var cluster_bases
@time ept2 = FermiCG.compute_pt2_energy(v_var, cluster_ops, clustered_ham, thresh_foi=1e-4,verbose=2,prescreen   = true,compress_twice = true)
