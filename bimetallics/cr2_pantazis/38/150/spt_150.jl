...
bst_energy, v = FermiCG.block_sparse_tucker(v, cluster_ops, clustered_ham,max_iter=200, thresh_var=8e-3, thresh_foi=5e-5,thresh_pt=1e-3,thresh_spin=9e-4);
@save "/home/arnab22/SPF-data/cr2_pantazis/rohf.def2svp/38__3d4d_2p3p/spin_corrected/data_bst_150.jld2" clusters init_fspace ints cluster_bases v
bst_energy, v = FermiCG.block_sparse_tucker(v, cluster_ops, clustered_ham,max_iter=200, thresh_var=8e-3, thresh_foi=2e-5,thresh_pt=1e-3,thresh_spin=9e-4);
@save "/home/arnab22/SPF-data/cr2_pantazis/rohf.def2svp/38__3d4d_2p3p/spin_corrected/data_bst_150.jld2" clusters init_fspace ints cluster_bases v

FermiCG.compute_pt2_energy(v, cluster_ops, clustered_ham, thresh_foi=1e-4,prescreen=true,compress_twice=true,verbose=2 )
