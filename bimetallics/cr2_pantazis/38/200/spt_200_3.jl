...
bst_energy, v = FermiCG.block_sparse_tucker(v, cluster_ops, clustered_ham,max_iter=5, thresh_var=7e-3, thresh_foi=3e-5,thresh_pt=9.5e-4,thresh_spin=9.5e-4);
...
bst_energy, v = FermiCG.block_sparse_tucker(v, cluster_ops, clustered_ham,max_iter=5, thresh_var=7e-3, thresh_foi=3e-5,thresh_pt=9.5e-4,thresh_spin=9.5e-4);
@save "/home/arnab22/SPF-data/cr2_pantazis/rohf.def2svp/38__3d4d_2p3p/spin_corrected/data_bst_200.jld2" clusters init_fspace ints cluster_bases v
bst_energy, v = FermiCG.block_sparse_tucker(v, cluster_ops, clustered_ham,max_iter=0, thresh_var=7e-3, thresh_foi=3e-5,thresh_pt=9.5e-4,thresh_spin=9.5e-4);
@save "/home/arnab22/SPF-data/cr2_pantazis/rohf.def2svp/38__3d4d_2p3p/spin_corrected/data_bst_200.jld2" clusters init_fspace ints cluster_bases v
bst_energy, v = FermiCG.block_sparse_tucker(v, cluster_ops, clustered_ham,max_iter=5, thresh_var=7e-3, thresh_foi=3e-5,thresh_pt=9.5e-4,thresh_spin=9.5e-4);
@save "/home/arnab22/SPF-data/cr2_pantazis/rohf.def2svp/38__3d4d_2p3p/spin_corrected/data_bst_200.jld2" clusters init_fspace ints cluster_bases v
