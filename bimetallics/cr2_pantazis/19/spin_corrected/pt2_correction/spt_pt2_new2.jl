...
FermiCG.compute_pt2_energy(v, cluster_ops, clustered_ham, thresh_foi=6e-6)
FermiCG.compute_pt2_energy(v, cluster_ops, clustered_ham, thresh_foi=1e-6)
FermiCG.compute_pt2_energy(v, cluster_ops, clustered_ham, thresh_foi=5e-7)
